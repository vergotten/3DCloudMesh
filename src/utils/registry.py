...
class Registry:
    ...
    @staticmethod
    def infer_scope():
        """Infers the scope of the registry based on where it is defined.
    ...
    def split_scope_key(key):
        """Splits a key into its scope and the remaining key.
    ...
    @property
    def scope(self):
        """Returns the scope of the registry."""
        return self._scope

    @property
    def module_dict(self):
        """Returns the module dictionary of the registry."""
        return self._module_dict

    @property
    def children(self):
        """Returns the children of the registry."""
        return self._children

    def get(self, key):
        """Gets a registry record by key.
        Args:
    ...
    def build(self, *args, **kwargs):
        """Builds an object using the build function of the registry."""
    ...
    def deprecated_register_module(self, cls=None, force=False):
        """Deprecated method for registering a module."""
        warnings.warn(
    ...
    def register_module(self, name=None, force=False, module=None):
        """Registers a module. Can be used as a decorator or a normal function.
