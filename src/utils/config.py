...
def log_args_to_file(args, pre='args', logger=None):
    """
    Logs the arguments to a file.

    Args:
        args (dict): The arguments to log.
        pre (str, optional): The prefix for the log. Defaults to 'args'.
...
def log_config_to_file(cfg, pre='cfg', logger=None):
    """
    Logs the configuration to a file.

    Args:
        cfg (dict): The configuration to log.
        pre (str, optional): The prefix for the log. Defaults to 'cfg'.
        logger (Logger, optional): The logger to use. Defaults to None.
    """
...
def merge_new_config(config, new_config):
    """
    Merges a new configuration into an existing one.

    Args:
        config (dict): The existing configuration.
...
def cfg_from_yaml_file(cfg_file):
    ...
    Args:
        cfg_file (str): The path to the YAML file.
